...
const TAB_ITEMS = [
  ...
  { id: 'desktop-pet', key: 'settings.tabs.desktopPet', d: '<path d="M12 21a9 9 0 0 0 9-9c0-3.5-2-6.5-5-8l-1 3-3-2-3 2-1-3c-3 1.5-5 4.5-5 8a9 9 0 0 0 9 9z"/><circle cx="9" cy="11" r="1.5"/><circle cx="15" cy="11" r="1.5"/><path d="M9 16c1.5 1 4.5 1 6 0"/>' },
  ...
  { id: 'prompt', key: 'settings.tabs.prompt', d: '<path d="M4 5h16"/><path d="M4 12h10"/><path d="M4 19h16"/><path d="M17 9l3 3-3 3"/>' },
  { id: 'context', key: 'settings.tabs.context', d: '<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/><path d="M8 9h8"/><path d="M8 13h4"/>' },
  ...
  { id: 'logs', key: 'settings.tabs.logs', d: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/>' },
